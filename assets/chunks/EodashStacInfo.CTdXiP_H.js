import"@eox/stacinfo";import{currentUrl as t}from"@/store/states";import{o as r,c as o,j as a,k as l}from"./framework.B09hBYeo.js";const i={class:"flex-grow-1 fill-height overflow-auto"},n=[".for",".allowHtml",".body",".featured",".footer",".styleOverride",".header",".subheader",".tags"],y={__name:"EodashStacInfo",props:{allowHtml:{type:Boolean,default:!0},styleOverride:{type:String,default:`
